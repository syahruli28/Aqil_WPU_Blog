...
@section('container')
    ...
    <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-4" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $post->title) }}" required autofocus> {{-- parameter kedua dari old() : value yang ada didb --}}
          @error('title')
    ...
    <script>
        ...
        // fungsi untuk mematikan fungsi file attachment trixx editor
